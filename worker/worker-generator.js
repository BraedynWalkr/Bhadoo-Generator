...
const jsURL = 'https://raw.githubusercontent.com/BraedynWalkr/Bhadoo-Generator/master/worker/worker-beta.js';

async function handleRequest(request) {
    let title = getParameterByName(request.url, 'site_name') || 'Braedyn Drive Index';
...
<head>
    ...
    <title>Braedyn Drive Index - Beta</title>
